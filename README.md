...
- `MAVEN_HOME` ayarlayın,
- veya Maven'i PATH'e ekleyin,
- veya `.tools/apache-maven-3.9.16` altına portable Maven kurun.

Selenium selector hatası:

- `chatbot.input.selector`
- `chatbot.send.selector`
- `chatbot.assistantMessage.selector`

alanlarını hedef chatbot DOM'una göre güncelleyin.